...
rm_chan_loop:                    ; for loop
    ; NOP pad keeps IRQ frequency at 120 Hz. This was found empirically:
    ;     1. Enable STANDLONE build
    ;     2. Scope IRQ pin 6 w/pic on programmer
    nop
...
; Restore FSR2/POSTINC2          ;  |      |
    ...
    clrf             FSR2H       ;  1      1      ; 1 cycle  (measured) <- Faster than movff by 1 cycle,
                                 ;  |      |      ;                        assume FSR2 won't wrap bank
; Branch on carry/borrow         ;  |      |
; of above subwfb                ;  |      |
