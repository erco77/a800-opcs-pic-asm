...
# PIC Firmware for OPCS A800 IBM PC ISA card - Stepper Motor Pulse Generator
    ...
    stepper motor drivers like the Gecko 201X and Centent CNO-142/143.
     ...
     |         |        #                                                         ,---#--> Motor A steps
     |    IRQ5 |<-------#------------------------------------------------.        |---#--> Motor A dir
     |         |        #                                          ______|____    |---#--> Motor B steps
     |         |        #                                         |           |   |---#--> Motor B dir
     |         |        #         8255 PPI               ,--/8/-->|  PIC CPU1 |---+---#--> Motor C steps
     |         |        #     ___________________        | Data   |___________|   |---#--> Motor C dir
     |         |        #    |                   |       |          | |           |---#--> Motor D steps
     ...
     |         |        #    |                   |  | |  |         _|_|_______    |---#--> Motor F steps
     |         |        #    |___________________|  | |  |        |           |   |---#--> Motor F dir
     |_________|        #                           | |  `--/8/-->|  PIC CPU2 |---+---#--> Motor G steps
                        #                           | |    Data   |___________|   |---#--> Motor G dir
                        #                           | |             | |           |---#--> Motor H steps
                        #                           | |_____________| |           `---#--> Motor H dir
                        #                           |_________________|               #
                        #                              Data Strobe/Ack                #
                        #                                & Vel Start                  #
                        #                                                             #
